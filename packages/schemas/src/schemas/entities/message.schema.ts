...
import { DBTableSchema, JsonBSchema, UUIDSchema } from '../utils';
...
export const DocumentContentSchema = Type.Object({
    filePath: Type.String(),
...
export const ContactContentSchema = Type.Object({
...
export const LocationContentSchema = Type.Object({
...
export const EventContentSchema = Type.Object({
...
export const SystemContentSchema = Type.Object({
