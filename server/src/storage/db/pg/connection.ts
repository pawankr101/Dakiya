...
const initTables = async (connection: Sql) => {
    try {
        ...
        throw new Exception('Failed to initialize database tables.', { cause: error as Error });
    }
}
const createRequiredEnums = async (connection: Sql) => {
    try {
        ...
        throw new Exception('Failed to create required enums.', { cause: error as Error });
    }
}
const createUserTable = async (connection: Sql) => {
    try {
        ...
        throw new Exception('Failed to create users table.', { cause: error as Error });
    }
}
const createUserSettingsTable = async (connection: Sql) => {
    try {
        ...
        throw new Exception('Failed to create user_settings table.', { cause: error as Error });
    }
}
const createDevicesTable = async (connection: Sql) => {
    try {
        ...
        throw new Exception('Failed to create devices table.', { cause: error as Error });
    }
}
const createConversationsTable = async (connection: Sql) => {
    try {
        ...
        throw new Exception('Failed to create conversations table.', { cause: error as Error });
    }
}
const createConversationMembersTable = async (connection: Sql) => {
    try {
        ...
        throw new Exception('Failed to create conversation_members table.', { cause: error as Error });
    }
}
const createMessagesTable = async (connection: Sql) => {
    try {
        ...
        throw new Exception('Failed to create messages table.', { cause: error as Error });
    }
}
const createMessageReactionsTable = async (connection: Sql) => {
    try {
        ...
        throw new Exception('Failed to create message_reactions table.', { cause: error as Error });
    }
}
const createMessageEditsTable = async (connection: Sql) => {
    try {
        ...
        throw new Exception('Failed to create message_edits table.', { cause: error as Error });
    }
}
const createMediaTable = async (connection: Sql) => {
    try {
        ...
        throw new Exception('Failed to create media table.', { cause: error as Error });
    }
}
const createDeliveryQueueTable = async (connection: Sql) => {
    try {
        ...
        throw new Exception('Failed to create delivery_queue table.', { cause: error as Error });
    }
}
const createIndexes = async (connection: Sql) => {
    try {
        ...
        throw new Exception('Failed to create indexes.', { cause: error as Error });
    }
}
...
export const PG = (() => {
    ...
    const createConnection = async () => {
        try {
            ...
            throw new Exception('Failed to establish PostgreSQL connection.', { cause: error as Error });
        }
    };
