...
type MessageType = 'text' | 'media' | 'location' | 'poll' | 'event';

type NonMediaMessageContent<T = MessageType> = T extends 'text' ? TextMessageContent
...
export class MessageReaction extends Model {
    public static readonly table = 'message_reactions';
